  ...
  return (
    <>
      <main className='w-screen h-screen flex items-center justify-center overflow-x-hidden'>
        <div className='w-1/2 h-full flex flex-col gap-10 items-center justify-center mx-auto'>
          <div className="flex flex-col font-poppins text-left w-3/5 h-full py-6">
