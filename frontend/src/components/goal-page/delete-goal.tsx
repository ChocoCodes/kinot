...
export const DeleteGoal = ({ onClose, name, id }: DeleteGoalProps) => {
    ...
    return (
        <div className="fixed inset-0 backdrop-blur-xs bg-black/10 flex items-center justify-center z-50">
            <div className='bg-white p-4 rounded-md flex flex-col gap-4 items-center font-poppins'>
                <div className="flex w-9/10 justify-between items-center text-xl font-semibold pb-4 border-b-2 border-gray-400">
